...
public class ProdottoEliminatoJDialog extends JDialog {
	...
	private final JPanel ProdottoEliminatoPanel = new JPanel();
	...
	public ProdottoEliminatoJDialog(ControllerMagazzino c, JFrame FinestraDaCuiApro) {
		...
		ProdottoEliminatoPanel.setBorder(new EmptyBorder(5, 5, 5, 5));
		getContentPane().add(ProdottoEliminatoPanel, BorderLayout.CENTER);
		ProdottoEliminatoPanel.setLayout(null);
		...
		ProdottoEliminatoPanel.add(ProdottoEliminatoLB);
		...
		ProdottoEliminatoPanel.add(OkButton);
	}
}
