...
public class VisualizzaLatticiniJFrame extends JFrame {
	...
	public VisualizzaLatticiniJFrame(ControllerMagazzino c, ControllerPrincipale cp) {
		...
		FiltraPerCB.setModel(new DefaultComboBoxModel(new String[] {"ID Prodotto", "Nome", "Paese Mungitura", "Paese Lavorazione", "Data Mungitura", "Data Scadenza", "Valore", "Scorte (kg)"}));
		...
		FiltraPerLB.setBounds(223, 41, 65, 20);
		VisualizzaProdottiPanel.add(FiltraPerLB);
		
		JButton EliminaButton = new JButton("Elimina");
		EliminaButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ControllerM.VisualizzaLatticiniEliminaBottonePremuto();
			}
		});
