...
public class VisualizzaDettagliCarrelloJFrame extends JFrame {
	...
	public VisualizzaDettagliCarrelloJFrame(ControllerVendite c, ControllerPrincipale c1) {
		ControllerV = c;
		ControllerP = c1;
		...
		ClientiButton.setIcon(new ImageIcon(VisualizzaDettagliCarrelloJFrame.class.getResource("/Risorse/cliente.png")));
...
//				 DA FARE
		...
		VenditeButton.setIcon(new ImageIcon(VisualizzaDettagliCarrelloJFrame.class.getResource("/Risorse/vendite-menu.png")));
...
//				 DA FARE
		...
		MagazzinoButton.setIcon(new ImageIcon(VisualizzaDettagliCarrelloJFrame.class.getResource("/Risorse/magazzino.png")));
		...
		InfoButton.setIcon(new ImageIcon(VisualizzaDettagliCarrelloJFrame.class.getResource("/Risorse/info-menu.png")));
